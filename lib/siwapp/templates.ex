defmodule Siwapp.Templates do
  ...
  @fields_to_sanitize [:name, :identification, :email, :contact_person, :invoicing_address, :shipping_address, :notes, :terms]

  @doc """
  Strips all html tags/sanitizes all the string fields of an Invoice
  """
